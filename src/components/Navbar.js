        ...
        <div className="max-w-fullxl mx-auto px-10 py-3">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center space-x-3">
              ...
              <Link to="/login" className={`${isScrolled ? 'bg-white text-red-500 hover:bg-white hover:text-black' : 'bg-red-500 text-white hover:bg-white hover:text-red-500'} px-5 py-2 rounded-full font-semibold transition duration-300`}>
                Login
              </Link>

              <Link to="/signup" className={`${isScrolled ? 'bg-white text-red-500 hover:bg-white hover:text-black' : 'bg-red-500 text-white hover:bg-white hover:text-red-500'} px-5 py-2 rounded-full font-semibold transition duration-300`}>
                SignUp
              </Link>
